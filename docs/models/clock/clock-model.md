...
#### Environment Model
Concrete instance of an environment model (Environment.Model) which supplies a State  (Environment.State) instance describing the environment at a given time point.
